...
> Our aim of "If Gnosis" is to further Gnosis adoption by equipping developers with necessary API triggers, such as smart contract events, wallet actions, and market activity, and enriching current Gnosis applications with user-engaging feature sets, such as automated alerts, DutchX events, and Google Sheets integrations. 

> While the "If Gnosis" project is innately built for Gnosis developers, the platform's point-and-click solution will be available to all end-users, including token holders, traders, and DutchX users. 
### How long will it take 
> 20 weeks (5 months).
### How much funding are you requesting  
> $96,000 to build the project to completion.
...
* Triggers Include: 
    ...
    * DutchX events on markets, auctions
    * Safe events 
    * Subgraph events
    * Market activity
...
### Features
Our goal is to combine all forces of the Gnosis platform - Create, Trade, Hold - into a seamless triggers and events platform. We plan to utilize the DutchX, Gnosis Safe, and Gnosis Apollo libraries extensively. 

Phase I of implementation will consist of a full integration of all available API endpoints into a unified Gnosis API. This API will reside at a publicly available endpoint https://GnosisAPI.com (we own the domain). Subsequently, triggers will be integrated from the Gnosis platforms. For example, DutchX will provide triggers on auction related markets, DutchX subgraph will provide triggers on sell and buy orders, Gnosis Safe will provide triggers on safes, OpenMarketCap will provide triggers on trading events. Data sources will be integrated based on functionality and demand.
...
**Time and price estimate - 4 weeks, $19,200**
...
* Triggers for:
    ...
    * Smart contract events
    * DutchX events on markets and buy / sell orders
    * Safe events in Gnosis wallet
...
**Time and Price Estimate - 6 months, $28,800**
...
* Actions for:
    ...
    * Apollo events based on infrastructure
...
**Time and price estimate - 6 weeks, $28,800**
...
**Time and Price Estimate - 4 months, $19,200**
